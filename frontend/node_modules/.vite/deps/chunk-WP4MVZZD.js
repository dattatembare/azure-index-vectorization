...
setVersion("@fluentui/react-hooks", "8.6.27");
  ...
  if (true) {
    ...
    if (newIsControlled) {
      ...
      if (!(hasOnChange || isReadOnly) && !warningsMap.valueOnChange[componentId]) {
        ...
        warn("Warning: You provided a '".concat(valueProp, "' prop to a ").concat(componentName, " without an '").concat(onChangeProp, "' handler. ") + "This will render a read-only field. If the field should be mutable use '".concat(defaultValueProp, "'. ") + "Otherwise, set '".concat(onChangeProp, "'").concat(readOnlyProp ? " or '".concat(readOnlyProp, "'") : "", "."));
      }
      ...
      if (defaultValue !== void 0 && defaultValue !== null && !warningsMap.valueDefaultValue[componentId]) {
        ...
        warn("Warning: You provided both '".concat(valueProp, "' and '").concat(defaultValueProp, "' to a ").concat(componentName, ". ") + "Form fields must be either controlled or uncontrolled (specify either the '".concat(valueProp, "' prop, ") + "or the '".concat(defaultValueProp, "' prop, but not both). Decide between using a controlled or uncontrolled ") + "".concat(componentName, " and remove one of these props. More info: https://fb.me/react-controlled-components"));
      }
    }
...
setVersion("@fluentui/utilities", "8.13.16");
...
//# sourceMappingURL=chunk-WP4MVZZD.js.map
